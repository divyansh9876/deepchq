      ...
      illustration={
        searchId && !done ? (
          ...
          <div className="rounded-2xl bg-white p-8 shadow-xl text-center">
            <p className="text-lg font-medium">Report ready for {decodeURIComponent(name)}</p>
            <p className="mt-2 text-sm text-gray-500">Preview available — unlock full access</p>
          </div>
        )
      }
    >
